...
<body>
	<div class="w3-banner-main">
		<div class="center-container">
			<h1 class="header-w3ls">Cari Berkas</h1><br>
			...
			<?php
				...
				{
					$change = str_replace("/", "-", $result->no_berkas);
					//header('Content-Disposition: attachment; filename="Berkas_'.$result->tipe_berkas.'_'.$change.'.pdf"');
					echo "<div style='margin: auto; padding: 2%;'>";
					echo "<center>
							<p style='padding:15px; font-family: sans-serif; background-color:#dff0d8; color: black;'>$sukses<br><br>
								Nomor Berkas : <a href='".base_url()."berkas/".$result->path_berkas."' download='Berkas_".$result->tipe_berkas."_".$change.".pdf'>$result->no_berkas</a>
							</p>
						  </center>";
					echo "</div>";
				}
			...
			<div class="content-top">
				<div class="content-w3ls">
					<form action="<?php echo base_url()?>index.php/form/search" enctype="multipart/form-data" method="post">
						<div class="form-w3ls">
				...
				<p class="copyright" style="margin-top: 130px;">© 2017 Kedutaan Besar Republik Indonesia Kuala Lumpur | Design by <a href="#" >Intersys</a></p>
		</div>
	</div>
